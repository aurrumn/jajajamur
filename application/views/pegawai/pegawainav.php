        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>controller_pegawai/c_pegawai_petani">
                            <i class="fa fa-users"></i> Petani <span class="fa fa-chevron-right"></span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li><a><i class="fa fa-pagelines"></i> Data Singkong <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="<?php echo base_url(); ?>controller_pegawai/c_pegawai_singkong">Data Singkong</a>
                            </li>
                            <li><a href="<?php echo base_url(); ?>controller_pegawai/c_pegawai_core">Penilaian Singkong </a>
                            </li>
                        </ul>
                    </li>
<!--                    <li><a><i class="fa fa-bar-chart-o"></i> Data Kualitas Singkong <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
